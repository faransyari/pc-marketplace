...
export default function AccessoriesDropdown({ active, onMouseEnter, onMouseLeave }: AccessoriesDropdownProps) {
    return (
        <>
            {/* Overlay background */}
            <div
                    ...
                    {[
                        {
                            ...
                            items: [
                                ...
                                { href: "/accessories/usb-hubs", label: "USB Hubs" },
                                { href: "/accessories/card-readers", label: "Card Readers" },
                            ],
                        },
                        {
                            title: "Mounts & Stands",
                            items: [
                                { href: "/accessories/laptop-stands", label: "Laptop Stands" },
                                { href: "/accessories/monitor-arms", label: "Monitor Arms" },
                                { href: "/accessories/phone-stands", label: "Phone Stands" },
                            ],
                        },
                        {
                            title: "Other Accessories",
                            items: [
                                { href: "/accessories/bags", label: "Bags & Cases" },
                                { href: "/accessories/cleaning", label: "Cleaning Kits" },
                                { href: "/accessories/cooling-pads", label: "Cooling Pads" },
                                { href: "/accessories/surge-protectors", label: "Surge Protectors" },
                                { href: "/accessories/cable-management", label: "Cable Management" },
                            ],
                        },
                    ].map((col, colIdx) => (
